            ...
            for (let i = 0; i < axieAnchors.length; i++) {
                ...
                if (axie.stage > 2) {
                    if (options[SHOW_BREEDS_STATS_OPTION]) {
                        ...
                        let stats = "💚 " + axie.stats.hp + " ⚡ " + axie.stats.speed + " ⭐ " + axie.stats.skill + " 🔥 " + axie.stats.morale;
                        let qualityDiv = document.createElement("div");
                        qualityDiv.textContent = "✨ " + Math.round(axie.quality * 100) + "%";
                        ...
                        if ((content.childElementCount == 0)) {
                            ...
                            card.children[0].appendChild(qualityDiv);
                        }
                    }
                }
            }
